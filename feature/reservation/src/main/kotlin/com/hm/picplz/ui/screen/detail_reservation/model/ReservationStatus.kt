...
enum class ReservationStatus(
    ...
    WAITING_SCHEDULE(
        ...
        photographerTitleResId = R.string.reservation_status_photographer_title_waiting_schedule,
        photographerDescriptionResId = R.string.reservation_status_photographer_description_waiting_schedule,
    ),
    RESERVED(
        ...
        photographerTitleResId = R.string.reservation_status_photographer_title_reserved,
        photographerDescriptionResId = R.string.reservation_status_photographer_description_reserved,
    ),
    COMPLETED(
        ...
        photographerTitleResId = R.string.reservation_status_photographer_title_completed,
